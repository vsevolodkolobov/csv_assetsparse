package kolobov.assetsParse

import kolobov.assetsParse.parsers.CSVParseUtils
...
//       parse a line
       ...
       String fileLocation = MainApp.class.getClassLoader().getResource(fileName).getFile()
       // Parse headers
